...
public class GamePadInfo
{
    ...
    /// Sets the vibration for all motors of this gamepad.
    /// </summary>
    /// <param name="leftStrength">The strength of the left motor vibration from 0.0f (none) to 1.0f (full).</param>
    /// <param name="rightStrength">The strength of the right motor vibration from 0.0f (none) to 1.0f (full).</param>
    /// <param name="time">The amount of time the vibration should occur.</param>
    public void SetVibration(float leftStrength, float rightStrength, TimeSpan time)
    {
        _vibrationTimeRemaining = time;
