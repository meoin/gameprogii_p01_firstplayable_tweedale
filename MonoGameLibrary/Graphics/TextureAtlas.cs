...
{
    // Store dictionarys for texture regions and animations
    ...
    /// </summary>
    /// <param name="regionName">The name of the region to create the sprite with.</param>
    /// <param name="sprite">The scale of the sprite.</param>
    /// <returns>A new Sprite using the texture region with the specified name.</returns>
    public Sprite CreateSprite(string regionName, float scale)
    {
        TextureRegion region = GetRegion(regionName);
    ...
    /// </summary>
    /// <param name="animationName">The name of the animation to use.</param>
    /// <param name="scale">The scale of the animated sprite.</param>
    /// <returns>A new AnimatedSprite using the animation with the specified name.</returns>
    public AnimatedSprite CreateAnimatedSprite(string animationName, float scale)
    {
        Animation animation = GetAnimation(animationName);
