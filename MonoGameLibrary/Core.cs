...
public class Core : Game
{
    ...
    /// <summary>
    /// Gets a reference to the default background color.
    /// </summary>
    public static Color BackgroundColor;

    /// <summary>
    /// Gets a reference to the default screen size bounds.
    /// </summary>
    ...
    public Core(string title, int width, int height, bool fullScreen)
    {
        ...
        Canvas = new Canvas(Graphics.GraphicsDevice, width, height);
    ...
    public static void ToggleFullscreen()
    {
        ...
        {
            SetResolution(_defaultWidth, _defaultHeight);
        }

        Graphics.ApplyChanges();
    }

    private static void SetFullscreenResolution()
    {
        DisplayMode display = GraphicsAdapter.DefaultAdapter.CurrentDisplayMode;
        SetResolution(display.Width, display.Height);
    }
