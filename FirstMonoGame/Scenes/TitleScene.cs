...
{
    private const string SIMON_TEXT = "Simon";
    private const string QUEST_TEXT = "Quest";
    ...
    public override void Draw(GameTime gameTime)
    {
        ...
        if (_titleScreenButtonsPanel.IsVisible)
        {
            ...
            Core.SpriteBatch.DrawString(_font5x, SIMON_TEXT, _dungeonTextPos + new Vector2(10, 10), dropShadowColor, 0.0f, _dungeonTextOrigin, 1.0f + _textScaleModifier, SpriteEffects.None, 1.0f);

            // Draw the Dungeon text on top of that at its original position.
            Core.SpriteBatch.DrawString(_font5x, SIMON_TEXT, _dungeonTextPos, Color.White, 0.0f, _dungeonTextOrigin, 1.0f + _textScaleModifier, SpriteEffects.None, 1.0f);

            // Draw the Slime text slightly offset from it is original position and
            // with a transparent color to give it a drop shadow.
            Core.SpriteBatch.DrawString(_font5x, QUEST_TEXT, _slimeTextPos + new Vector2(10, 10), dropShadowColor, 0.0f, _slimeTextOrigin, 1.0f - _textScaleModifier, SpriteEffects.None, 1.0f);
    ...
    private void HandleStartClicked(object sender, EventArgs e)
    {
        ...
        Core.ChangeScene(new StartRoom("start-room"));
    }
    ...
    private void HandleSfxSliderChanged(object sender, EventArgs args)
    {
        ...
        Core.Audio.SetSoundEffectVolume((float)slider.Value);
    }
    ...
    private void HandleMusicSliderValueChanged(object sender, EventArgs args)
    {
        ...
        Core.Audio.SetMusicVolume((float)slider.Value);
    }
