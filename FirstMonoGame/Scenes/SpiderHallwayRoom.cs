...
public class SpiderHallwayRoom : GameplayScene
{
    ...
    public override void Initialize()
    {
        ...
        _enemies.Add(new Spider(3, GetSpecificTile(8, 3), _spiderSprite, _player));
        _enemies.Add(new Spider(3, GetSpecificTile(13, 4), _spiderSprite, _player));
        _enemies.Add(new Spider(3, GetSpecificTile(15, 2), _spiderSprite, _player));
        _enemies.Add(new Spider(3, GetSpecificTile(20, 3), _spiderSprite, _player));
        _enemies.Add(new Spider(3, GetSpecificTile(25, 4), _spiderSprite, _player));
        _enemies.Add(new Spider(3, GetSpecificTile(29, 2), _spiderSprite, _player));
        _enemies.Add(new Spider(3, GetSpecificTile(33, 4), _spiderSprite, _player));
        _enemies.Add(new Spider(3, GetSpecificTile(36, 3), _spiderSprite, _player));
